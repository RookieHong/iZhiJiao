...
App({
    ...
    places: [
        {
            img:"../../images/xipinxiaoxue.jpg",
            title:"桑植县河口乡西坪小学(湖南支教学校)",
            content: "西坪小学位于湖南省张家界市桑植县河口乡西坪村，是一所村级完全小学。",
            profile:"2017秋季学期有7名教师，108名学生。其中天使支教志愿者3人（男性1名，女性2名） 。有7个教学班，分别为学前班、一年级、二年级，三年级、四年级、五年级、六年级，采用分班教学。",
            date:"2017年9月"
        },
        {
            img:"../../images/xinhecun.jpg",
            title: "广西融水县汪洞乡新合村小学（广西支教学校）",
            content: "新合村小学距离融水县城约150多公里，距离柳州市约280多公里。从柳州市坐火车（客车）到融水县约2个半小时，从融水县坐客车到同练乡约4个半小时。  ",
            profile: "新合小学现有（2014年9月）学生30人，其中学前班9人；二年级5人；三年级16人。本地教师一名，支教志愿者一名。本地教师负责学前班和二年级的教学。志愿者负责三年级教学。",
            date: "2014年9月"
        }
    ],
    teams: [
